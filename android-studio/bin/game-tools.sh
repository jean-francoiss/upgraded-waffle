...
message()
{
  TITLE="Cannot start Android StudioGameTools"
...
PATHS_SELECTOR="AndroidGameDevelopmentTools"
...
if [ -z "$JDK" ] && [ -s "${XDG_CONFIG_HOME:-$HOME/.config}/${PRODUCT_VENDOR}/${PATHS_SELECTOR}/studio.jdk" ]; then
  USER_JRE=$("$CAT" "${XDG_CONFIG_HOME:-$HOME/.config}/${PRODUCT_VENDOR}/${PATHS_SELECTOR}/studio.jdk")
  if [ ! -d "$USER_JRE" ]; then
...
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/android/lib/*"
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/android/resources/*"
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/java/lib/java-api.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/java/lib/java-impl.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/java/lib/resources.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/plugins/java/lib/java_resources_en.jar"
